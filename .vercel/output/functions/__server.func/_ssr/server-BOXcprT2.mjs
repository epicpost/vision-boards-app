...
import { b as au, I as Iu, o as ou } from "../_libs/seroval.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DblEagnh.mjs");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Bd-4THC9.mjs").then((n) => n.F),
    import("./start-JyeE7RSX.mjs"),
