...
var tt$1 = { 0: "Symbol.asyncIterator", 1: "Symbol.hasInstance", 2: "Symbol.isConcatSpreadable", 3: "Symbol.iterator", 4: "Symbol.match", 5: "Symbol.matchAll", 6: "Symbol.replace", 7: "Symbol.search", 8: "Symbol.species", 9: "Symbol.split", 10: "Symbol.toPrimitive", 11: "Symbol.toStringTag", 12: "Symbol.unscopables" }, ve$1 = { [v$1]: 0, [pr$1]: 1, [R$1]: 2, [C$1]: 3, [dr$1]: 4, [gr$1]: 5, [yr$1]: 6, [Nr$1]: 7, [br$1]: 8, [vr$1]: 9, [Cr$1]: 10, [P$1]: 11, [Ar$1]: 12 }, ot$1 = { 2: "!0", 3: "!1", 1: "void 0", 0: "null", 4: "-0", 5: "1/0", 6: "-1/0", 7: "0/0" }, o$1 = void 0;
...
var H = B$1(2), J$1 = B$1(3), Ae$1 = B$1(1), Ee$1 = B$1(0), it$1 = B$1(4), ut$1 = B$1(5), lt$1 = B$1(6), ct$1 = B$1(7);
function mn(e) {
  switch (e) {
    case '"':
      return '\\"';
...
var Pt$1 = {}, xt$1 = {};
var Tt$1 = { 0: {}, 1: {}, 2: {}, 3: {}, 4: {}, 5: {} }, Ot = { 0: "[]", 1: Nt, 2: bt, 3: vt, 4: Ct, 5: It$1 };
function Xe$1(e) {
...
function Qt(e, r, t, n) {
  return t ? F(e.base, t) ? (w$1(e.base, r), Ne(e, r, n, m(e, t.i)), "") : f(e, t) : "";
}
function jo(e, r) {
...
function Yo(e, r) {
  return Yr(e, r.o, r.i), un$1(e, r, r.p);
}
function qo(e, r, t, n) {
  let a = un$1(e, r, t);
...
function Ho(e, r) {
  return Yr(e, r.o, r.i), Wr$1(e, r, Oo);
}
function Jo(e) {
  return 'new Date("' + e.s + '")';
}
...
function Xo(e, r) {
  ...
  if (a > 0) {
    ...
    for (let d = 1, G2 = S; d < a; d++) G2 = tn(e, s, n[d], g[d], u), S += (G2 && S && ",") + G2;
    l.stack.pop(), S && (t += "([" + S + "])");
  }
...
function ta(e, r) {
  let t = r.i;
  e.base.stack.push(t);
  let n = Wr$1(e, r, 'new AggregateError([],"' + r.m + '")');
  return e.base.stack.pop(), n;
}
function na(e, r) {
  return Wr$1(e, r, "new " + Ce$1[r.s] + '("' + r.m + '")');
}
function oa(e, r) {
...
function ia(e, r) {
  if (e.mode === 1) throw new h$1(r);
  return q$1(e, r.a[0]) + "(" + m(e, r.i) + "," + f(e, r.a[1]) + ")";
}
function ua(e, r) {
  if (e.mode === 1) throw new h$1(r);
  return q$1(e, r.a[0]) + "(" + m(e, r.i) + "," + f(e, r.a[1]) + ")";
...
function ca(e, r) {
  let t = "", n = false;
  return r.f.t !== 4 && (w$1(e.base, r.f.i), t = "(" + f(e, r.f) + ",", n = true), t += ae$1(e, r.i, "(" + At + ")(" + m(e, r.f.i) + ")"), n && (t += ")"), t;
}
function fa(e, r) {
  return q$1(e, r.a[0]) + "(" + f(e, r.a[1]) + ")";
}
function Sa(e, r) {
  let t = r.a[0], n = r.a[1], a = e.base, s = "";
  t.t !== 4 && (w$1(a, t.i), s += "(" + f(e, t)), n.t !== 4 && (w$1(a, n.i), s += (s ? "," : "(") + f(e, n)), s && (s += ",");
  let i = ae$1(e, r.i, "(" + Et + ")(" + m(e, n.i) + "," + m(e, t.i) + ")");
  return s ? s + i + ")" : i;
}
function ma(e, r) {
  return q$1(e, r.a[0]) + "(" + f(e, r.a[1]) + ")";
...
function pa(e, r) {
  let t = ae$1(e, r.i, q$1(e, r.f) + "()"), n = r.a.length;
  if (n) {
    let a = f(e, r.a[0]);
...
function f(e, r) {
  switch (r.t) {
    ...
    case 34:
      return ya(e, r);
    default:
      return ae$1(e, r.i, ba$1(e, r));
  }
}
function fr$1(e, r) {
  let t = f(e, r), n = r.i;
  if (n == null) return t;
  let a = sn$1(e.base), s = m(e, n), i = e.state.scopeId, u = i == null ? "" : le, l = a ? "(" + t + "," + a + s + ")" : t;
...
function Jr$1(e) {
  return { type: 2, base: me(2, e), state: va$1(e) };
}
function Ca$1(e, r, t) {
  let n = [];
...
function Zr$1(e, r, t) {
  ...
  return C$1 in t && (a.push(I$1(e.base, C$1)), s.push(Ue$1(rr$1(e.base), E$1(e, r, $e$1(t))))), v$1 in t && (a.push(I$1(e.base, v$1)), s.push(je$1(tr$1(e.base), E$1(e, r, e.type === 1 ? re$1() : Qe$1(t))))), P$1 in t && (a.push(I$1(e.base, P$1)), s.push($$1(t[P$1]))), R$1 in t && (a.push(I$1(e.base, R$1)), s.push(t[R$1] ? H : J$1)), { k: a, v: s };
}
...
function ha$1(e, r, t) {
  if (this.state.alive) {
    let n = W(this, r, t);
    n && se(this, c$1(23, e, o$1, o$1, o$1, o$1, o$1, [k$1(this.base, 2), n], o$1, o$1, o$1, o$1)), be$1(this);
  }
}
function za$1(e, r, t) {
  if (this.state.alive) {
    let n = W(this, r, t);
    n && se(this, c$1(24, e, o$1, o$1, o$1, o$1, o$1, [k$1(this.base, 3), n], o$1, o$1, o$1, o$1));
  }
  be$1(this);
}
...
function ka$1(e, r, t, n, a) {
  for (let s = 0, i = a.length; s < i; s++) {
    let u = a[s];
    if (u.parse.sync && u.test(n)) return ce(t, u.tag, u.parse.sync(n, new Kr$1(e, r), { id: t }));
  }
  return o$1;
}
function Da$1(e, r, t, n, a) {
  for (let s = 0, i = a.length; s < i; s++) {
    let u = a[s];
    if (u.parse.stream && u.test(n)) return ce(t, u.tag, u.parse.stream(n, new Hr$1(e, r), { id: t }));
  }
  return o$1;
}
function cn(e, r, t, n) {
...
function et(e, r) {
  let t = W(e, 0, r);
  t && (Xr$1(e, t, true), e.state.initial = false, La(e, e.state), e.state.pending <= 0 && Sr(e));
}
function La(e, r) {
...
var ve = { [v]: 0, [mr]: 1, [R]: 2, [C]: 3, [pr]: 4, [dr]: 5, [gr]: 6, [yr]: 7, [Nr]: 8, [br]: 9, [vr]: 10, [P]: 11, [Cr]: 12 }, tt = { 0: v, 1: mr, 2: R, 3: C, 4: pr, 5: dr, 6: gr, 7: yr, 8: Nr, 9: br, 10: vr, 11: P, 12: Cr }, o = void 0, ot = { 2: true, 3: false, 1: o, 0: null, 4: -0, 5: Number.POSITIVE_INFINITY, 6: Number.NEGATIVE_INFINITY, 7: Number.NaN };
...
var Ar = /* @__PURE__ */ new Map(), j2 = /* @__PURE__ */ new Map();
function Er(e) {
  return Ar.has(e);
}
function dn(e) {
...
function ft(e) {
  if (dn(e)) return j2.get(e);
  throw new Pe(e);
}
typeof globalThis != "undefined" ? Object.defineProperty(globalThis, U, { value: j2, configurable: true, writable: false, enumerable: false }) : typeof window != "undefined" ? Object.defineProperty(window, U, { value: j2, configurable: true, writable: false, enumerable: false }) : typeof self != "undefined" ? Object.defineProperty(self, U, { value: j2, configurable: true, writable: false, enumerable: false }) : typeof global != "undefined" && Object.defineProperty(global, U, { value: j2, configurable: true, writable: false, enumerable: false });
function xe(e) {
  return e instanceof EvalError ? 1 : e instanceof RangeError ? 2 : e instanceof ReferenceError ? 3 : e instanceof SyntaxError ? 4 : e instanceof TypeError ? 5 : e instanceof URIError ? 6 : 0;
}
function gn(e) {
...
async function kr(e, r, t) {
  ...
  return C in t && (a.push(I(e.base, C)), s.push(Ue(er(e.base), await N(e, r, $e(t))))), v in t && (a.push(I(e.base, v)), s.push(je(rr(e.base), await N(e, r, Xe(t))))), P in t && (a.push(I(e.base, P)), s.push(X2(t[P]))), R in t && (a.push(I(e.base, R)), s.push(t[R] ? J : Z)), { k: a, v: s };
}
...
async function _t(e, r, t, n) {
  ...
  if (a) for (let s = 0, i = a.length; s < i; s++) {
    let u = a[s];
    if (u.parse.async && u.test(n)) return fe2(t, u.tag, await u.parse.async(n, new _r(e, r), { id: t }));
  }
  return o;
}
...
function Ut(e, r) {
  if (r < 0 || !Number.isFinite(r) || !Number.isInteger(r)) throw new h2({ t: 4, i: r });
...
function p(e, r, t) {
  ...
  switch (r += 1, t.t) {
    ...
    case 1:
      return D(String(t.s));
    case 3:
      if (String(t.s).length > Un) throw new h2(t);
      return BigInt(t.s);
    case 4:
...
function Jr(e, r, t) {
  ...
  return C in t && (a.push(I(e.base, C)), s.push(Ue(er(e.base), E(e, r, $e(t))))), v in t && (a.push(I(e.base, v)), s.push(je(rr(e.base), E(e, r, e.type === 1 ? te() : Xe(t))))), P in t && (a.push(I(e.base, P)), s.push(X2(t[P]))), R in t && (a.push(I(e.base, R)), s.push(t[R] ? J : Z)), { k: a, v: s };
}
...
function za(e, r, t, n, a) {
  for (let s = 0, i = a.length; s < i; s++) {
    let u = a[s];
    if (u.parse.sync && u.test(n)) return fe2(t, u.tag, u.parse.sync(n, new Gr(e, r), { id: t }));
  }
  return o;
}
function _a(e, r, t, n, a) {
  for (let s = 0, i = a.length; s < i; s++) {
    let u = a[s];
    if (u.parse.stream && u.test(n)) return fe2(t, u.tag, u.parse.stream(n, new Kr2(e, r), { id: t }));
  }
  return o;
}
function un(e, r, t, n) {
...
function au(e, r) {
  let t = A(r.plugins), n = Hr2({ plugins: t, refs: r.refs, disabledFeatures: r.disabledFeatures, depthLimit: r.depthLimit, onParse: r.onParse, onError: r.onError, onDone: r.onDone });
