...
const Captions = createLucideIcon("captions", __iconNode$T);
...
const Crop = createLucideIcon("crop", __iconNode$J);
const __iconNode$I = [
...
const FileTypeCorner = createLucideIcon("file-type-corner", __iconNode$C);
const __iconNode$B = [
...
const Ratio = createLucideIcon("ratio", __iconNode$j);
const __iconNode$i = [
...
const Sticker = createLucideIcon("sticker", __iconNode$b);
const __iconNode$a = [
  [
    "path",
    {
