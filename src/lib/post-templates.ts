...
const LOCAL_POST_TEMPLATES: PostTemplate[] = [
  {
    ...
    remix_id: null,
    description:
      'A beauty editorial poster with a rounded portrait cutout, required "BEAUTY 2025" label, required "New Collection" headline and optional "U & ME" footer wordmark.',
    ...
    input_requirements: {
      ...
      text_requirements: [
        ...
        },
        {
          ...
          ai_can_rewrite: true,
          allowed_values: [],
          description: 'Required top label. Default: "BEAUTY 2025".',
        },
        {
          key: "footer_wordmark",
          label: "U & ME",
  ...
  },
  {
    ...
    remix_id: null,
    description:
      'A fixed pool collage story with one required "summer mood" caption repeated along three diagonal white strips.',
    ...
    capabilities: {
      supports_ai_generation: false,
      supports_remix: true,
      supports_asset_replacement: false,
      supports_text_rewrite: true,
      supports_brand_adaptation: true,
      supports_aspect_ratio_conversion: false,
      supports_language_adaptation: true,
