...
const MODERN_FASHION_ID = "11000000-0000-0000-0000-000000000059";
const JUST_LISTED_ID = "11000000-0000-0000-0000-000000000060";
const BELONG_ESTATE_ID = "11000000-0000-0000-0000-000000000061";
const APERTURE_DUBAI_ID = "11000000-0000-0000-0000-000000000062";

const LOCAL_POST_TEMPLATES: PostTemplate[] = [
  {
    id: APERTURE_DUBAI_ID,
    title: "Skyline Focus",
    preview: "/templates/shared/d7e0d71e1c76c423f1bc2e5438c44699.jpg",
    preview_type: "image",
    preview_width: 736,
    preview_height: 1104,
    likes_count: 0,
    ...
    assets: [
      {
        id: `${APERTURE_DUBAI_ID}-preview`,
        url: "/templates/shared/d7e0d71e1c76c423f1bc2e5438c44699.jpg",
        type: "image",
        order: 0,
        width: 736,
        height: 1104,
    ...
    remix_id: null,
    description:
      'A blurred full-bleed photo backdrop with one narrow, thin-bordered strip of the same photo left sharp — a window of focus through the blur. An optional top-left logo, a required "A **smarter** way to **buy**" headline + subtitle sit beside the strip; an optional caption and a handle rotated vertical along the strip\'s edge sit below.',
    tags: ["real estate", "property", "skyline", "poster", "social post"],
    comments: [],
    created_at: "2026-07-09T00:00:00.000Z",
    updated_at: "2026-07-09T00:00:00.000Z",
    template_type: "image",
    template_subtype: "aperture_focus_poster",
      ...
      assets: [
        {
          ...
          preferred_aspect_ratios: ["2:3", "4:5", "3:4"],
          min_width: 720,
          min_height: 1080,
          allow_crop: true,
          ...
          description:
            "One required photo — it fills the blurred backdrop and, cropped narrow and sharp, the window of focus.",
        },
        {
          key: "logo",
          type: "logo",
          ...
          preferred_aspect_ratios: ["3:1", "2:1", "1:1"],
          min_width: 96,
          min_height: 32,
          allow_crop: false,
          allow_background_extend: false,
          ...
          description: "Optional top-left logo.",
        },
      ],
      text_requirements: [
        {
          ...
          allowed_values: [],
          description:
            'Required two-line headline set beside the strip. Wrap a word in "**double asterisks**" to set it bold-italic. Default: "A **smarter**\\nway to **buy**".',
        },
        {
          key: "description",
          label: "Website",
          ...
          allowed_values: [],
          description:
            'Optional subtitle under the headline — filled with the brand\'s website when attached. Default: "Imperial Alfa Real Estate".',
        },
        {
          key: "handle",
          label: "Handle",
          ...
          allowed_values: [],
          description:
            'Optional handle, rotated vertical along the strip\'s edge. Default: "@imperialalfa".',
        },
        {
          key: "caption",
          label: "Caption",
          ...
          allowed_values: [],
          description:
            'Optional caption below the strip. Wrap a word in "**double asterisks**" to set it bold. Default: "**Follow** Imperial Alfa for curated **UAE real estate** insights and opportunities.".',
        },
      ],
      text_density: "medium",
    ...
    agent_hints: {
      render_template: "client:aperture",
      render_defaults: {
  ...
  },
  {
    id: BELONG_ESTATE_ID,
    title: "Belong Estate",
    preview: "/templates/shared/aad6353a5c0eca9816292e4c6708f142.jpg",
    preview_type: "image",
    preview_width: 1080,
    preview_height: 1350,
    likes_count: 0,
    ...
    assets: [
      {
        id: `${BELONG_ESTATE_ID}-preview`,
        url: "/templates/shared/aad6353a5c0eca9816292e4c6708f142.jpg",
        type: "image",
        order: 0,
        width: 1080,
        height: 1350,
    ...
    remix_id: null,
    description:
      'A two-photo real-estate collage with a full-bleed lifestyle backdrop, a floating property photo, an optional "BELONG / Cartagena de Indias" wordmark, a required "Become a smart investor." headline and an optional bottom-right approval badge.',
    tags: ["real estate", "investment", "property", "collage", "poster", "social post"],
    comments: [],
    created_at: "2026-07-09T00:00:00.000Z",
    updated_at: "2026-07-09T00:00:00.000Z",
    template_type: "image",
    template_subtype: "estate_collage_poster",
      ...
      assets: [
        {
          ...
          transparent_preferred: false,
          description:
            "Two required photos, in order: a lifestyle/context backdrop, then a property or amenity photo that floats over the seam.",
        },
        {
          key: "logo",
          type: "logo",
          ...
          max_count: 1,
          accepted_mime_types: ["image/png", "image/svg+xml", "image/webp"],
          preferred_aspect_ratios: ["2:1", "3:2", "1:1"],
          min_width: 128,
          min_height: 64,
          allow_crop: false,
          allow_background_extend: false,
          allow_background_removal: false,
          transparent_preferred: true,
          description: "Optional bottom-right approval badge or agency logo.",
        },
      ],
      text_requirements: [
        {
          ...
          allowed_values: [],
          description:
            'Optional two-line wordmark centred in the panel — a tracked brand name over a small script location line. Default: "BELONG\\nCartagena de Indias".',
        },
        {
          key: "headline",
          label: "Headline",
          ...
          allowed_values: [],
          description:
            'Required serif headline set over the backdrop photo. Default: "Become a smart investor."',
        },
      ],
      text_density: "low",
      text_overflow_strategy: "wrap",
  ...
  },
  {
    id: JUST_LISTED_ID,
    title: "Just Listed",
    preview: "/templates/shared/7382bcf56dc5e2eac13c5445de2cf0eb.jpg",
    preview_type: "image",
    preview_width: 1080,
    preview_height: 1350,
    likes_count: 0,
    ...
    assets: [
      {
        id: `${JUST_LISTED_ID}-preview`,
        url: "/templates/shared/7382bcf56dc5e2eac13c5445de2cf0eb.jpg",
        type: "image",
        order: 0,
        width: 1080,
        height: 1350,
    ...
    remix_id: null,
    description:
      'A real-estate "Just Listed" post with a full-bleed listing photo, a required "Just listed" headline, an optional "in City" caption and a required "Take a peak →" button.',
    tags: ["real estate", "just listed", "listing", "property", "poster", "social post"],
    comments: [],
    created_at: "2026-07-09T00:00:00.000Z",
    updated_at: "2026-07-09T00:00:00.000Z",
    template_type: "image",
    template_subtype: "just_listed_poster",
    aspect_ratio: "1080 / 1350",
    slide_count: 1,
    input_image_count: 1,
    render_engine: "client",
      ...
      assets: [
        {
          ...
          allow_background_removal: false,
          transparent_preferred: false,
          description: "One required full-bleed listing or property photo.",
        },
        {
          key: "logo",
          type: "logo",
          ...
          allow_background_removal: false,
          transparent_preferred: true,
          description: "Optional brokerage or agent logo, hidden by default.",
        },
      ],
      text_requirements: [
        {
          ...
          allowed_values: [],
          description:
            'Required two-word headline — the first word renders roman, the rest italic on the same line. Default: "Just listed".',
        },
        {
          key: "caption",
          label: "Caption",
          ...
          ai_can_rewrite: true,
          allowed_values: [],
          description: 'Optional caption under the headline. Default: "in City".',
        },
        {
          key: "cta",
          ...
          required: true,
          max_chars: 24,
          recommended_chars: 13,
          visible_on_asset: true,
          ai_can_generate: false,
          ai_can_rewrite: true,
          allowed_values: [],
          description: 'Required button label. Default: "Take a peak →".',
        },
      ],
      text_density: "low",
    ...
    carousel_requirements: null,
    agent_hints: {
      render_template: "client:listing",
      render_defaults: {
        caption_color: "#ffffff",
        caption_color_options: [
          { label: "White", value: "#ffffff" },
  ...
  {
    id: MODERN_FASHION_ID,
    title: "Modern Fashion",
    preview: "/templates/shared/d636bdebe9a88f0ff93b08171d8035e9.jpg",
    preview_type: "image",
    preview_width: 1199,
    preview_height: 1799,
    likes_count: 0,
    ...
    assets: [
      {
        id: `${MODERN_FASHION_ID}-preview`,
        url: "/templates/shared/d636bdebe9a88f0ff93b08171d8035e9.jpg",
        type: "image",
        order: 0,
        width: 1199,
        height: 1799,
    ...
    remix_id: null,
    description:
      'A modern fashion editorial poster with one required portrait image, a required "high, modern & fashion." title/caption and optional 01, 20 and 30 labels.',
    tags: ["fashion", "editorial", "modern", "portrait", "poster", "lookbook"],
    comments: [],
    created_at: "2026-07-08T00:00:00.000Z",
    updated_at: "2026-07-08T00:00:00.000Z",
    template_type: "image",
    template_subtype: "modern_fashion_poster",
    aspect_ratio: "1199 / 1799",
    slide_count: 1,
    input_image_count: 1,
    render_engine: "client",
    render_mode: "editor",
      ...
      assets: [
        {
          ...
          max_count: 1,
          accepted_mime_types: ["image/jpeg", "image/png", "image/webp"],
          preferred_aspect_ratios: ["2:3", "3:4", "4:5", "1:1"],
          min_width: 720,
          min_height: 960,
          allow_crop: true,
          allow_background_extend: false,
          ...
          transparent_preferred: false,
          description:
            "One required fashion, beauty, portrait, or campaign image revealed through the geometric cutouts.",
        },
      ],
      text_requirements: [
        {
          ...
          required: true,
          max_chars: 60,
          recommended_chars: 23,
          visible_on_asset: true,
          ai_can_generate: true,
          ai_can_rewrite: true,
          allowed_values: [],
          description: 'Required title/caption. Default: "high, modern & fashion."',
        },
        {
          key: "text_01",
          label: "Text 01",
          ...
          ai_can_rewrite: true,
          allowed_values: [],
          description: 'Optional small left label. Default: "01".',
        },
        {
          key: "text_20",
          label: "Text 20",
          ...
          ai_can_rewrite: true,
          allowed_values: [],
          description: 'Optional bottom-right top label. Default: "20".',
        },
        {
          key: "text_30",
          label: "Text 30",
          ...
          ai_can_rewrite: true,
          allowed_values: [],
          description: 'Optional bottom-right lower label. Default: "30".',
        },
      ],
      text_density: "medium",
      text_overflow_strategy: "wrap",
    ...
    output_spec: {
      supported_aspect_ratios: ["1199 / 1799"],
      default_aspect_ratio: "1199 / 1799",
      supported_formats: ["png", "jpeg", "webp"],
      default_format: "png",
      resolution_presets: [{ aspect_ratio: "1199 / 1799", width: 1199, height: 1799 }],
      has_safe_area: true,
      has_transparent_background: false,
      contains_text_overlay: true,
    ...
    carousel_requirements: null,
    agent_hints: {
      render_template: "client:modern-fashion",
      render_defaults: {
